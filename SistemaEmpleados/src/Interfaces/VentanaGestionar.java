...
public class VentanaGestionar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dateFechaContratoG = new com.toedter.calendar.JDateChooser();
        ...
        jPanel1.add(dateFechaContratoG, new org.netbeans.lib.awtextra.AbsoluteConstraints(187, 168, 103, -1));
        jPanel1.add(dateFecha_Nac, new org.netbeans.lib.awtextra.AbsoluteConstraints(41, 168, 103, -1));
    ...
    private void tablaEmployeesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaEmployeesMouseClicked
        ...
        //dateFecha_Nac.setDate((java.util.Date) tablaEmployees.getValueAt(s, 1));
    ...
    private com.toedter.calendar.JDateChooser dateFechaContratoG;
